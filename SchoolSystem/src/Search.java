...
public class Search {
	 ...
	 * @param target the element that must be found
	 * @return int the index of the number in the array(-1 if it isn't in the array)
	 */
	...
	/**
	 * This method determines the targets position in the array(int), and returns -1 if it isn't in the array.
	 * @param a array of ints
	 * @param start starting index
	 * @param end ending index
	 * @param target target the method is searching for
	...
	/**
	 * This method determines the targets position in the array(double), and returns -1 if it isn't in the array.
	 * @param a array of doubles
	 * @param start starting index
	 * @param end ending index
	 * @param target target the method is searching for
	...
	/**
	 * This method determines the targets position in the array(string), and returns -1 if it isn't in the array.
	 * @param a array of strings
	 * @param start starting index
	 * @param end ending index
	 * @param target target the method is searching for
